...
import { KeyIcon, PlusIcon, TrashIcon } from "@/modules/ui/icons";
		...
		>
			<div className="grid grid-cols-1 gap-2">
					...
					passkeys?.map((passkey) => (
						<div key={passkey.id} className="flex gap-2">
							...
							<div className="flex-1">
								...
								<small className="block text-muted-foreground text-xs leading-tight">
									{formatter.dateTime(
				...
				<div className="flex justify-start">
					<Button type="button" variant="light" onClick={addPasskey}>
