...
import { ChevronsUpDownIcon, PlusIcon } from "@/modules/ui/icons";
...
export function OrganzationSelect({ className }: { className?: string }) {
	...
	return (
		<div className={className}>
			<DropdownMenu>
				<DropdownMenuTrigger className="flex w-full items-center justify-between gap-2 rounded-md border p-2 text-left outline-none focus-visible:bg-primary/10 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2">
