	...
	const onSubmit = form.handleSubmit(async ({ email, password, name }) => {
		try {
			...
			if (invitationOnlyMode && invitationId) {
				// Organization plugin removed - invitation acceptance disabled
				// TODO: Implement organization invitation acceptance via ORPC if needed
				// For now, redirect to organization invitation page after signup
				router.push(`/organization-invitation/${invitationId}`);
				return;
			}
