...
import { XIcon } from "@/modules/ui/icons";
...
const sheetVariants = cva(
	"fixed z-50 gap-4 bg-background p-6 shadow-modal transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out md:shadow-modal-desktop",
	{
		variants: {
			side: {
